Name:       wpewebkit2
Summary:    WPE WebKit 2.54.0 for Sailfish OS
Version:    2.54.0
Release:    1
License:    LGPLv2+ and BSD and MPLv2.0
URL:        https://wpewebkit.org
# Download from: https://wpewebkit.org/releases/wpewebkit-2.54.0.tar.xz
...
%description
WPE WebKit 2.54.0 built for Sailfish OS 5.1 aarch64 (Snapdragon 665,
...
%package devel
Summary:    Development files for WPE WebKit 2.54.0
Requires:   %{name} = %{version}-%{release}

%description devel
Headers and pkg-config files for building against WPE WebKit 2.54.0
on Sailfish OS.
